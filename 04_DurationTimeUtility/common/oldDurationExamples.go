...
func GetTargetTimeFromMinusDuration() {
	...
	du.CalcTargetTimeFromMinusDuration(t1, TimeDto{Years: 1})
...
func GetTargetTimeFromMinusDuration2() {
	...
	du.CalcTargetTimeFromMinusDuration(t1, TimeDto{Years: 1, Months: 2, Days: 3})
...
func GetTargetTimeFromPlusDuration() {
	...
	du.CalcTargetTimeFromPlusDuration(t1, TimeDto{Years: 1, Months: 2, Days: 3})
