...
func TestDurationTriad_SetStartEndTimes_05(t *testing.T) {
...
func TestDurationTriad_SetStartEndTimes_06(t *testing.T) {
	...
	if err == nil {
		t.Error("Expected error return from dur.SetStartEndTimesTz() because\n"+
			"input parameter 'TDurCalc.None()' is invalid.\n" +
			"However, NO ERROR WAS RETURNED!!\n")
	}

}

func TestDurationTriad_SetStartEndTimes_07(t *testing.T) {
	...
	if err == nil {
		t.Error("Expected error return from dur.SetStartEndTimesTz() because\n"+
			"input parameter time zone location name is invalid.\n" +
			"However, NO ERROR WAS RETURNED!!\n")
	}

}

func TestDurationTriad_SetStartEndTimes_08(t *testing.T) {
	...
	if err == nil {
		t.Error("Expected error return from dur.SetStartEndTimesTz() because\n"+
			"input parameter 'TCalcMode.None()' is invalid.\n" +
			"However, NO ERROR WAS RETURNED!!\n")
	}
...
func TestDurationTriad_SetDefaultStartTimeDuration_01(t *testing.T) {
	...
	err := dur.SetDefaultStartTimeDuration(
		t1,
		t12Dur)

	if err != nil {
		t.Errorf("Error returned by dur.SetDefaultStartTimeDuration(...). "+
			"Error='%v'", err.Error())
	}
...
func TestDurationTriad_SetDefaultStartTimeTzDuration_01(t *testing.T) {
	t1str := "02/15/2014 19:54:30.000000000 -0600 CST"
	t2str := "04/30/2017 22:58:32.000000000 -0500 CDT"
	fmtstr := "01/02/2006 15:04:05.000000000 -0700 MST"
	...
	err = dur.SetDefaultStartTimeTzDuration(
		dTz1,
		t12Dur)

	if err != nil {
		t.Errorf("Error returned by dur.SetDefaultStartTimeTzDuration(...). "+
			"Error='%v'", err.Error())
	}
...
func TestDurationTriad_SetStartTimePlusTimeDto_04(t *testing.T) {
	t1str := "02/15/2014 19:54:30.000000000 -0600 CST"
	t2str := "04/30/2017 22:58:32.000000000 -0500 CDT"
	fmtstr := "01/02/2006 15:04:05.000000000 -0700 MST"
...
func TestDurationTriad_SetStartTimePlusTimeDto_05(t *testing.T) {
	t1str := "02/15/2014 19:54:30.000000000 -0600 CST"
	fmtstr := "01/02/2006 15:04:05.000000000 -0700 MST"
	...
	if err == nil {
		t.Error("Expected an error return from dur.SetStartTimePlusTimeDto(...)\n"+
			"because input parameter 'TDurCalc.None()' is invalid.\n" +
			"However, NO ERROR WAS RETURNED!\n")
	}
}

func TestDurationTriad_SetStartTimePlusTimeDto_06(t *testing.T) {
	t1str := "02/15/2014 19:54:30.000000000 -0600 CST"
	fmtstr := "01/02/2006 15:04:05.000000000 -0700 MST"
...
func TestDurationTriad_SetStartTimePlusTimeDto_07(t *testing.T) {
	t1str := "02/15/2014 19:54:30.000000000 -0600 CST"
	fmtstr := "01/02/2006 15:04:05.000000000 -0700 MST"
...
func TestDurationTriad_SetDefaultStartTimePlusTimeDto_01(t *testing.T) {
	t1str := "02/15/2014 19:54:30.000000000 -0600 CST"
	t2str := "04/30/2017 22:58:32.000000000 -0500 CDT"
	fmtstr := "01/02/2006 15:04:05.000000000 -0700 MST"
	...
	err := dur.SetDefaultStartTimePlusTimeDto(
		t1,
		timeDto)

	if err != nil {
		t.Errorf("Error returned by dur.SetDefaultStartTimePlusTimeDto(t1, timeDto, "+
			"FmtDateTimeYrMDayFmtStr) Error='%v' ", err.Error())
	}
...
func TestDurationTriad_SetDefaultStartTimeTzPlusTimeDto_01(t *testing.T) {
	t1str := "02/15/2014 19:54:30.000000000 -0600 CST"
	t2str := "04/30/2017 22:58:32.000000000 -0500 CDT"
	fmtstr := "01/02/2006 15:04:05.000000000 -0700 MST"
	t1, _ := time.Parse(fmtstr, t1str)
	...
	err = dur.SetDefaultStartTimeTzPlusTimeDto(
		dTz1,
		timeDto)

	if err != nil {
		t.Errorf("Error returned by dur.SetDefaultStartTimeTzPlusTimeDto(dTz1, timeDto)\n"+
			"Error='%v'\n", err.Error())
		return
	}
