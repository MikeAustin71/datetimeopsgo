...
// sub-second subMicrosecondNanoseconds.
//
// NOTE: (1) Before calling this method, ensure that tDur.startDateTimeTz,
//           TimeDurationDto.endDateTimeTz and TimeDurationDto.timeDuration
//           are properly initialized.
...
// in seconds, milliseconds, microseconds and subMicrosecondNanoseconds.
//
...
// calcTypeGregorianYears - Allocates Years using the number of subMicrosecondNanoseconds in a
...
// calcYearsFromDuration - Calculates number of years duration and subMicrosecondNanoseconds
...
// setStartTimeAddDateTime - Receives a starting date time and proceeds to add
...
//       appropriate error message. If the method succeeds, an error value
//       of 'nil' will be returned signaling successful completion and a
//       successful update of all 'tDur' data fields.
//
func (tDurDtoUtil *timeDurationDtoUtility) setStartTimeAddDateTime(
	tDur *TimeDurationDto,
	startDateTime time.Time,
	years,
	months,
	...
	ePrefix += "timeDurationDtoUtility.setStartTimeAddDateTime() "
	...
	endDateTimeTz, err = dTzUtil.addDateTime(
		&startDateTimeTz,
		timeMathCalcMode,
		years,
		months,
	...
	if endDateTimeTz.dateTimeValue.Before(
		startDateTimeTz.dateTimeValue) {

		tempTz := startDateTimeTz.CopyOut()

		startDateTimeTz = endDateTimeTz.CopyOut()

		endDateTimeTz = tempTz.CopyOut()
	}
	...
	err = tDurDtoUtil2.setStartEndTimesTz(
		&tDur2,
		startDateTimeTz,
		endDateTimeTz,
		tDurCalcType,
