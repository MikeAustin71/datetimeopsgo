...
func TestDateTimeFormatUtility_ParseDateTimeStrings(t *testing.T) {
	...
	if err != nil {
		t.Errorf("Error returned by dtf.CreateAllFormatsInMemory(). Error='%v'",
			err.Error())
	}
...
func GetXDateTimeSamples() [][][]string {
	...
	d = append(d, [][]string{{"2018-02-25 16:28:52.515539300 +1000 +10", "Sunday February 25, 2018 16:28:52.515539300 +1000 +1000"}})
	//                         2018-02-25 16:28:52.515539300 +1000 +10
	// expected Saturday February 25, 2018 16:28:52.515539300 +1000 +10
	// actual   Sunday February 25, 2018 16:28:52.515539300 +1000 +1000
	return d
}
