...
func TestDurationTriad_CopyOut_01(t *testing.T) {
	t1str := "02/15/2014 19:54:30.000000000 -0600 CST"
	t2str := "04/30/2017 22:58:32.000000000 -0500 CDT"
	fmtstr := "01/02/2006 15:04:05.000000000 -0700 MST"
...
func TestDurationTriad_IsValid_01(t *testing.T) {
	t1str := "02/15/2014 19:54:30.000000000 -0600 CST"
	t2str := "04/30/2017 22:58:32.000000000 -0500 CDT"
	fmtstr := "01/02/2006 15:04:05.000000000 -0700 MST"
	t1, _ := time.Parse(fmtstr, t1str)
	...
	if err != nil {
		t.Errorf("Error: Since dur is valid, dur.IsValid()\n" +
			"should have returned err==nil.\n" +
			"Instead, err='%v'\n", err.Error())
	}

}

func TestDurationTriad_IsValid_02(t *testing.T) {
	t1str := "02/15/2014 19:54:30.000000000 -0600 CST"
	t2str := "04/30/2017 22:58:32.000000000 -0500 CDT"
	fmtstr := "01/02/2006 15:04:05.000000000 -0700 MST"
	t1, _ := time.Parse(fmtstr, t1str)
	...
	dur.UTCTime.timeDurCalcType = TDurCalc.None()

	err = dur.IsValid()

	if err == nil {
		t.Error("Error: Since dur is invalid, dur.IsValid()\n" +
			"should have returned err!=nil.\n" +
			"Instead, err==nil'\n")
	}
}
...
func TestDurationTriad_NewAutoEnd_02(t *testing.T) {

	locCentral, err := time.LoadLocation(TZones.US.Central())

	if err != nil {
		t.Errorf("Error returned by time." +
			"LoadLocation(TZones.US.Central()).\n" +
			"Error='%v'", err.Error())
	}

	startDateTime := time.Now().In(locCentral)

	_, err = DurationTriad{}.NewAutoEnd(
		startDateTime,
		TDurCalc.None(),
		TZones.US.Central(),
		TCalcMode.LocalTimeZone(),
	...
	if err == nil {
		t.Error("Expected an error return from DurationTriad{}.NewAutoEnd()\n" +
			"because 'TDurCalc.None()' is invalid.\n" +
...
func TestDurationTriad_NewDefaultStartTimeDuration_01(t *testing.T) {
	...
	dur, err := DurationTriad{}.NewDefaultStartTimeDuration(
		t1,
		t12Dur)

	if err != nil {
		t.Errorf("Error returned by DurationTriad{}." +
			"NewDefaultStartTimeDuration(t1, t12Dur).\n" +
			"Error='%v'\n", err.Error())
		return
	}
...
func TestDurationTriad_NewDefaultStartDateTzDuration_01(t *testing.T) {
	t1str := "02/15/2014 19:54:30.000000000 -0600 CST"
	t2str := "04/30/2017 22:58:32.000000000 -0500 CDT"
	fmtstr := "01/02/2006 15:04:05.000000000 -0700 MST"
	...
	dur, err := DurationTriad{}.NewDefaultStartTimeTzDuration(
		t1DateTz,
		t12Dur)

	if err != nil {
		t.Errorf("Error returned by DurationTriad{}." +
			"NewDefaultStartTimeTzDuration(t1DateTz, t12Dur).\n"+
			"Error='%v'\n", err.Error())
		return
	}
...
func TestDurationTriad_NewDefaultStartEndTimesTz_01(t *testing.T) {
	t1str := "02/15/2014 19:54:30.000000000 -0600 CST"
	t2str := "04/30/2017 22:58:32.000000000 -0500 CDT"
	fmtstr := "01/02/2006 15:04:05.000000000 -0700 MST"
	...
	dur, err := DurationTriad{}.NewDefaultStartEndTimesTz(
		dateTz1,
		dateTz2)
...
func TestDurationTriad_NewStartEndTimes_01(t *testing.T) {
	...
	if err != nil {
		t.Errorf("Error returned by DurationTriad{}.NewStartEndTimes(t1, t2).\n" +
			"Error='%v'\n", err.Error())
		return
	}
...
func TestDurationTriad_NewStartEndTimes_02(t *testing.T) {
	t1str := "02/15/2014 19:54:30.000000000 -0600 CST"
	t2str := "04/30/2017 22:58:32.000000000 -0500 CDT"
	fmtstr := "01/02/2006 15:04:05.000000000 -0700 MST"
	...
	_, err := DurationTriad{}.NewStartEndTimes(
		t1,
		t2,
		TDurCalc.None(),
		TZones.US.Central(),
	...
	if err == nil {
		t.Error("Expected an error return from " +
			"DurationTriad{}.NewStartEndTimes(t1, t2).\n" +
			"because parameter TDurCalc.None() is invalid.\n" +
			"However, NO ERROR WAS RETURNED!!\n")
		return
	}
...
func TestDurationTriad_NewStartEndTimes_03(t *testing.T) {
	t1str := "02/15/2014 19:54:30.000000000 -0600 CST"
	t2str := "04/30/2017 22:58:32.000000000 -0500 CDT"
	fmtstr := "01/02/2006 15:04:05.000000000 -0700 MST"
	...
	if err == nil {
		t.Error("Expected an error return from " +
			"DurationTriad{}.NewStartEndTimes(t1, t2).\n" +
			"because parameter time zone location 'XXXXX' is invalid.\n" +
			"However, NO ERROR WAS RETURNED!!\n")
		return
	}
}

func TestDurationTriad_NewStartEndTimes_04(t *testing.T) {
	t1str := "02/15/2014 19:54:30.000000000 -0600 CST"
	t2str := "04/30/2017 22:58:32.000000000 -0500 CDT"
	fmtstr := "01/02/2006 15:04:05.000000000 -0700 MST"
...
func TestDurationTriad_NewStartEndTimes_05(t *testing.T) {
	t1str := "02/15/2014 19:54:30.000000000 -0600 CST"
	t2str := "04/30/2017 22:58:32.000000000 -0500 CDT"
	fmtstr := "01/02/2006 15:04:05.000000000 -0700 MST"
...
func TestDurationTriad_NewDefaultStartEndTimes_01(t *testing.T) {
	t1str := "02/15/2014 19:54:30.000000000 -0600 CST"
	t2str := "04/30/2017 22:58:32.000000000 -0500 CDT"
	fmtstr := "01/02/2006 15:04:05.000000000 -0700 MST"
	...
	dur, err := DurationTriad{}.NewDefaultStartEndTimes(
		t1,
		t2)

	if err != nil {
		t.Errorf("Error returned by DurationTriad{}." +
			"NewDefaultStartEndTimes(t1, t2).\n" +
			"Error='%v'\n", err.Error())
		return
	}
...
func TestDurationTriad_NewDefaultEndTimeMinusTimeDto_01(t *testing.T) {
	t1str := "02/15/2014 19:54:30.000000000 -0600 CST"
	t2str := "04/30/2017 22:58:32.000000000 -0500 CDT"
	fmtstr := "01/02/2006 15:04:05.000000000 -0700 MST"
	...
	dur, err := DurationTriad{}.NewDefaultEndTimeMinusTimeDto(
		t2,
		timeDto)

	if err != nil {
		t.Errorf("Error returned by DurationTriad{}." +
			"NewDefaultEndTimeMinusTimeDto(t2, timeDto).\n" +
			"Error='%v'\n", err.Error())
		return
	}
...
func TestDurationTriad_NewEndTimeTzMinusTimeDto_02(t *testing.T) {
	t1str := "02/15/2014 19:54:30.000000000 -0600 CST"
	t2str := "04/30/2017 22:58:32.000000000 -0500 CDT"
	fmtstr := "01/02/2006 15:04:05.000000000 -0700 MST"
...
func TestDurationTriad_NewEndTimeTzMinusTimeDto_03(t *testing.T) {
	t2str := "04/30/2017 22:58:32.000000000 -0500 CDT"
	fmtstr := "01/02/2006 15:04:05.000000000 -0700 MST"
	...
	_, err = DurationTriad{}.NewEndTimeTzMinusTimeDto(
		dTz2,
		timeDto,
		TDurCalc.None(),
		TZones.US.Central(),
	...
	if err == nil {
		t.Error("Expected an error return from DurationTriad{}.NewEndTimeTzMinusTimeDto(dTz2, timeDto)\n" +
			"because parameter 'TDurCalc.None()' is invalid.\n" +
			"However, NO ERROR WAS RETURNED!!\n")
		return
	}
...
func TestDurationTriad_NewEndTimeTzMinusTimeDto_04(t *testing.T) {
	t2str := "04/30/2017 22:58:32.000000000 -0500 CDT"
	fmtstr := "01/02/2006 15:04:05.000000000 -0700 MST"
...
func TestDurationTriad_NewEndTimeTzMinusTimeDto_05(t *testing.T) {
	t2str := "04/30/2017 22:58:32.000000000 -0500 CDT"
	fmtstr := "01/02/2006 15:04:05.000000000 -0700 MST"
...
func TestDurationTriad_NewDefaultEndTimeTzMinusTimeDto_01(t *testing.T) {
	t1str := "02/15/2014 19:54:30.000000000 -0600 CST"
	t2str := "04/30/2017 22:58:32.000000000 -0500 CDT"
	fmtstr := "01/02/2006 15:04:05.000000000 -0700 MST"
	...
	dur, err = DurationTriad{}.NewDefaultEndTimeTzMinusTimeDto(
		dTz2,
		timeDto)

	if err != nil {
		t.Errorf("Error returned by DurationTriad{}." +
			"NewDefaultEndTimeTzMinusTimeDto(dTz2, timeDto).\n" +
			"Error='%v'\n", err.Error())
		return
	}
...
func TestDurationTriad_NewDefaultStartTimePlusTimeDto_01(t *testing.T) {
	...
	dur, err := DurationTriad{}.NewDefaultStartTimePlusTimeDto(
		t1,
		timeDto)

	if err != nil {
		t.Errorf("Error returned by DurationTriad{}." +
			"NewDefaultStartTimePlusTimeDto(t1, timeDto).\n" +
			"Error='%v'\n", err.Error())
		return
	}
...
func TestDurationTriad_NewDefaultStartTimeTzPlusTimeDto_01(t *testing.T) {
	t1str := "02/15/2014 19:54:30.000000000 -0600 CST"
	t2str := "04/30/2017 22:58:32.000000000 -0500 CDT"
	fmtstr := "01/02/2006 15:04:05.000000000 -0700 MST"
	t1, _ := time.Parse(fmtstr, t1str)
	...
	dur, err = DurationTriad{}.NewDefaultStartTimeTzPlusTimeDto(
		dTz1,
		timeDto)

	if err != nil {
		t.Errorf("Error returned by DurationTriad{}." +
			"NewDefaultStartTimeTzPlusTimeDto(t1, timeDto).\n" +
			"Error='%v'\n", err.Error())
		return
	}
