...
func TestDateTzDto_AddDate_01(t *testing.T) {
	...
	if err != nil {
		t.Errorf("Error returned by DateTzDto{}.NewStartEndTimes(t1, fmtstr).\n" +
			"Error='%v'", err.Error())
		return
	}
...
func TestDateTzDto_CopyIn_01(t *testing.T) {
	...
	if err != nil {
		t.Errorf("Error returned by DateTzDto{}.NewStartEndTimes(t2, fmtstr).\n" +
			"Error='%v'\n", err.Error())
		return
	}
...
func TestDateTzDto_CopyOut(t *testing.T) {
	...
	dTzDtoInitial, err := DateTzDto{}.NewDateTime(t1, FmtDateTimeYrMDayFmtStr)
	...
	if t1ExpectedZone != tz.GetOriginalZoneName() {
		t.Errorf("Error: Expected dTzDto.GetTimeZoneDef().ZoneName='%v'.\n" +
			"Instead, dTzDto.GetTimeZoneDef().ZoneName='%v'", t1ExpectedZone, tz.GetOriginalZoneName())
	}
...
func TestDateTzDto_GetConvertibleTzStatusFlags_01(t *testing.T) {
	...
	dTzDto, err = DateTzDto{}.NewDateTime(dateTime, fmtStr)

	if err != nil {
		t.Errorf("Error returned by DateTzDto{}.NewStartEndTimes(dateTime, fmtStr).\n" +
			"dateTime='%v'\n" +
...
func TestDateTzDto_GetTimeDto_01(t *testing.T) {
	...
	dTz1, err := DateTzDto{}.NewDateTime(t4USCentral, FmtDateTimeYrMDayFmtStr)
