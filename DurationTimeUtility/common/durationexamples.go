...
func ExampleNewstarttimeduration01() {
	...
	if err != nil {
		fmt.Printf("Error from DurationUtility.GetYearMthDaysTime. Error: %v\n", err.Error())
	}
	...
	ns += 3 * common.HourNanoSeconds
	ns += 4 * common.MinuteNanoSeconds
	ns += 2 * common.SecondNanoseconds
	...
	fmt.Println("           Info 1-Hour NanoSeconds: ", common.HourNanoSeconds)
}
