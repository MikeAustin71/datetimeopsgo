...
func PrintOutDateTzDtoFields(dtz dt.DateTzDto) {
	...
	fmt.Println("      WeekDay: ", dtz.Time.WeekDays)
	fmt.Println("      DateDay: ", dtz.Time.DateDays)
	fmt.Println("         Hour: ", dtz.Time.Hours)
	fmt.Println("       Minute: ", dtz.Time.Minutes)
	fmt.Println("       Second: ", dtz.Time.Seconds)
	fmt.Println("  Millisecond: ", dtz.Time.Milliseconds)
	fmt.Println("  Microsecond: ", dtz.Time.Microseconds)
	fmt.Println("   Nanosecond: ", dtz.Time.Nanoseconds)
	fmt.Println("TotalNanoSecs: ", dtz.Time.Nanoseconds)
