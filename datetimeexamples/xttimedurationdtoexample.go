...
func ExampleTimeDuration001() {
	...
	fmt.Println("       Actual End Date Time: ", t1Dur.GetThisEndDateTime().Format(dt.FmtDateTimeYrMDayFmtStr))
...
func PrintTimeDurationDto(tDur dt.TimeDurationDto) {
	...
	fmt.Println("     startTimeDateTz: ", tDur.GetThisStartDateTimeString())
	...
	fmt.Println("Total Duration Nanoseconds: ", int64(tDur.GetThisTimeDuration()))
	fmt.Println("-----------------------------------------------------")
